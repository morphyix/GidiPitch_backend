            ...
            <tr>
              <td style="padding:10px 30px 30px 30px; font-family:'Poppins', Arial, sans-serif;">
                <h1 style="margin:0; font-size:22px; font-weight:700; color:#1d1d1d;">
                  You’re on the GidiPitch waitlist
                </h1>
                ...
                <p style="margin:5px 0; font-size:15px; color:#333333; line-height:1.6;">
                  Thanks for signing up! You’re officially on the GidiPitch waitlist.
                  We’re building the simplest way for African founders to create pitch decks,
                ...
                <p style="margin:20px 0; font-size:15px; color:#333333; line-height:1.6;">
                  You’re in good company — thousands of African founders are using GidiPitch to move faster and smarter.
                </p>
          ...
          <table width="600" cellpadding="0" cellspacing="0" border="0" style="margin-top:5px;">
            <tr>
              <td align="center" style="font-size:14px; color:#555555; padding:5px 20px; font-family:'Poppins', Arial, sans-serif;">
                <strong style="margin-bottom: 5px;">GidiPitch</strong><br />
            ...
            <tr>
              <td align="center" style="padding-bottom:30px;">
                <div style="text-align:center;">
                  <a href="https://x.com/gidipitch" style="margin:0 5px; display:inline-block; width:36px; height:36px; background-color:#FF6B35; border-radius:50%; text-align:center; line-height:36px;">
                    <i class="fa-brands fa-x-twitter" style="color:#ffffff; font-size:18px;"></i>
                  </a>
                  <a href="https://www.instagram.com/gidipitch/" style="margin:0 5px; display:inline-block; width:36px; height:36px; background-color:#FF6B35; border-radius:50%; text-align:center; line-height:36px;">
                    <i class="fa-brands fa-instagram" style="color:#ffffff; font-size:18px;"></i>
                  </a>
                  <a href="https://www.linkedin.com/company/gidipitch" style="margin:0 5px; display:inline-block; width:36px; height:36px; background-color:#FF6B35; border-radius:50%; text-align:center; line-height:36px;">
